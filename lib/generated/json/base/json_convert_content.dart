...
class JsonConvert {
	static final Map<String, JsonConvertFunction> _convertFuncMap = {
		(DownloadVideoInfoEntity).toString(): DownloadVideoInfoEntity.fromJson,
		(DownloadVideoInfoList).toString(): DownloadVideoInfoList.fromJson,
		(FlvVideoResultEntity).toString(): FlvVideoResultEntity.fromJson,
		(FlvVideoResultDurl).toString(): FlvVideoResultDurl.fromJson,
		(FlvVideoResultSupportFormats).toString(): FlvVideoResultSupportFormats.fromJson,
  ...
  T? asT<T extends Object?>(dynamic value) {
	...
	static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
		if(<DownloadVideoInfoEntity>[] is M){
			return data.map<DownloadVideoInfoEntity>((Map<String, dynamic> e) => DownloadVideoInfoEntity.fromJson(e)).toList() as M;
		}
		if(<DownloadVideoInfoList>[] is M){
			return data.map<DownloadVideoInfoList>((Map<String, dynamic> e) => DownloadVideoInfoList.fromJson(e)).toList() as M;
		}
		if(<FlvVideoResultEntity>[] is M){
			return data.map<FlvVideoResultEntity>((Map<String, dynamic> e) => FlvVideoResultEntity.fromJson(e)).toList() as M;
		}
		if(<FlvVideoResultDurl>[] is M){
			return data.map<FlvVideoResultDurl>((Map<String, dynamic> e) => FlvVideoResultDurl.fromJson(e)).toList() as M;
		}
		if(<FlvVideoResultSupportFormats>[] is M){
			return data.map<FlvVideoResultSupportFormats>((Map<String, dynamic> e) => FlvVideoResultSupportFormats.fromJson(e)).toList() as M;
		}
